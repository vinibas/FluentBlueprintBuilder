...
/// This type is also used as the preset type (TPreset) for the overloaded generic base; presets are
/// factory functions that return an instance of <typeparamref name="TBuilder"/> which supplies preset values.</typeparam>
...
{
    /// <summary>
    /// Registers a factory that returns the current builder instance in the presets dictionary with the key "default".
    /// </summary>
    protected override void ConfigurePresets(IDictionary<string, Func<TBuilder>> presets)
        => presets.Add("default", () => (TBuilder)this);
}